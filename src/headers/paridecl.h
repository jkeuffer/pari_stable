...
void    gerepilemanyvec(pari_sp av, pari_sp tetpil, long *g, int n);
...
GEN     divis_rem(GEN x, long y, ulong *rem);
...
GEN     divsi_rem(long x, GEN y, ulong *rem);
...
long    invsmod(long x, long p);
ulong   invumod(ulong x, ulong p);
