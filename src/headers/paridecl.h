...
GEN     idealred_elt0(GEN nf, GEN I, GEN vdir);
...
int     ell_is_padic(GEN e);
int     ell_is_real(GEN e);
...
GEN     RgXQ_caract(GEN x, GEN T, long v);
...
INLINE GEN    cgetg_copy(long lx, GEN x);
...
INLINE GEN    ctofp(GEN x, long prec);
...
INLINE GEN    init_gen_op(GEN x, long tx, long *lx, long *i);
...
INLINE GEN    bitvec_alloc(long n);
INLINE void   bitvec_clear(GEN bitvec, long b);
INLINE void   bitvec_set(GEN bitvec, long b);
INLINE GEN    bitvec_shorten(GEN bitvec, long n);
INLINE long   bitvec_test(GEN bitvec, long b);
INLINE long   bitvec_test_set(GEN bitvec, long b);
