...
long    Flxq_issquare(GEN x, GEN T, ulong p);
...
long    FpXQ_issquare(GEN x, GEN T, GEN p);
...
GEN gp_default(const char *a, const char *b);
...
long    os_open(const char *s, int mode);
...
void    pariflush(void);
void    parifprintf(FILE *file, const char *fmt, ...);
void    pariprintf(const char *fmt, ...);
void    pariputc(char c);
void    pariputs(const char *s);
char*   parisprintf(const char *fmt, ...);
void    parivfprintf(FILE *file, const char *fmt, va_list ap);
void    parivprintf(const char *fmt, va_list ap);
char*   parivsprintf(const char *fmt, va_list ap);
int     popinfile(void);
void    print(GEN g);
void    print1(GEN g);
...
void    parivprintf(const char* fmt, va_list args);
...
void*   gpcalloc(size_t size);
void*   gpmalloc(size_t bytes);
void*   gprealloc(void *pointer,size_t size);
void    gunclone(GEN x);
void    killbloc(GEN x);
GEN     listcopy(GEN x);
...
GEN     FpV_center(GEN z, GEN p, GEN pov2);
