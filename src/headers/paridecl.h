...
void    gerepilemany(gpmem_t av, GEN* g[], long n);
void    gerepilemanycoeffs(gpmem_t av, GEN x, long n);
void    gerepilemanysp(gpmem_t av, gpmem_t tetpil, GEN* g[], long n);
void    gerepilemanyvec(gpmem_t av, gpmem_t tetpil, long *g, long n);
