...
{"apprpadic",2,(void *)padicappr,7,"GG"},
...
{"direuler",83,(void *)direuler0,7,"V=GGIDG"},
...
{"globalred",1,(void *)ellglobalred,5,"G"},
...
{"ideallistarchgen",3,(void *)ideallistarch,6,"GGG"},
{"ideallistunit",21,(void *)ideallistunit,6,"GL"},
{"ideallistunitarch",3,(void *)ideallistarch,6,"GGG"},
{"ideallistunitarchgen",3,(void *)ideallistarch,6,"GGG"},
...
{"intgen",99,(void *)intnumromb0,9,"V=GGID1,L,p"},
{"intinf",99,(void *)intnumromb0,9,"V=GGID2,L,p"},
{"intnum",99,(void *)intnumromb0,9,"V=GGID0,L,p"},
{"intopen",99,(void *)intnumromb0,9,"V=GGID3,L,p"},
...
{"isoncurve",20,(void *)oncurve,5,"iGG"},
...
{"prodeuler",37,(void *)prodeuler0,9,"V=GGIp"},
{"prodinf",27,(void *)prodinf0,9,"V=GID0,L,p"},
{"prodinf1",27,(void *)prodinf0,9,"V=GID1,L,p"},
...
{"rayclassno",2,(void *)bnrclassno,6,"GG"},
{"rayclassnolist",2,(void *)bnrclassnolist,6,"GG"},
...
{"weberf",1,(void *)weberf,3,"Gp"},
{"weberf2",1,(void *)weberf2,3,"Gp"},
...
char *oldhelpmessage[] =
{
  ...
  "core2(n)= (long)gen_2-component row vector [d,f], where d is the unique squarefree integer dividing n such that n/d=f^2 is a square",
  "coredisc(n)=discriminant of the quadratic field Q(sqrt(n))",
  "coredisc2(n)= (long)gen_2-component row vector [d,f], where d is the discriminant of the quadratic field Q(sqrt(n)) and n=df^2. f may be a half integer",
  "cos(x)=cosine of x",
  ...
  "gaussmodulo(M,D,Y)= (long)gen_1 solution of system of congruences MX=Y mod D",
  ...
  "idealtwoelt(nf,x)= (long)gen_2-element representation of an ideal x in the number field nf",
  "idealtwoelt2(nf,x,a)= (long)gen_2-element representation of an ideal x in the number field nf, with the first element equal to a",
  ...
  "weberf(x)=Weber's f function of x (j=(f^24-16)^3/f^24)",
  "weberf2(x)=Weber's f2 function of x (j=(f2^24+16)^3/f2^24)",
