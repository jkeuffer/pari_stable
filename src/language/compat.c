...
{"issquare",1,(void*)gcarreparfait,4,"G","issquare(x)=true(1) if x is a square, false(0) if not"},
...
{"rnfhermitebasis",2,(void*)rnfhermitebasis,6,"GG","rnfhermitebasis(bnf,order)=given an order as output by rnfpseudobasis, gives either a true HNF basis of the order if it exists, zero otherwise"},
