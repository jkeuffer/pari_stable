...
void  plot(entree *ep, GEN a, GEN b, GEN code, GEN ysmlu, GEN ybigu, long prec);
GEN   ploth(entree *ep, GEN a, GEN b, GEN code, long prec, long flag, long numpoints);
GEN   ploth2(entree *ep, GEN a, GEN b, GEN code, long prec);
GEN   plothmult(entree *ep, GEN a, GEN b, GEN code, long prec);
...
GEN   postploth(entree *ep,GEN a,GEN b,GEN code,long prec,long flag,long numpoints);
GEN   postploth2(entree *ep,GEN a,GEN b,GEN code,long prec,long numpoints);
...
GEN   rectploth(long drawrect,entree *ep, GEN a, GEN b, GEN code, long prec, ulong flags, long testpoints);
