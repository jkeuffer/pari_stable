...
ser_to_pol_i(GEN x, long lx)
{
  ...
  i = lx-1; while (i > 1 && gcmp0(gel(x,i))) i--;
...
poltoser(GEN x, long v, long prec)
{
  ...
  lx = lg(x); i = 2; while (i<lx && gcmp0(gel(x,i))) i++;
