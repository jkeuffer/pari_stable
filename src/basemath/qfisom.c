...
autom(struct group *G, struct qfauto *qf, struct fingerprint *fp,
                                          struct qfcand *cand)
{
  long i, j, step, im, nC, nH, found, try;
  GEN  x, orb, bad, H;
  long nbad;
  GEN V = qf->V;
