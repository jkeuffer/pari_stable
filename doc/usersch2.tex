...
(types \tet{t_FRAC} and \tet{t_FRACN}): under \kbd{gp}, all fractions are
...
If you really want a reducible fraction under \kbd{gp}, you must use the \kbd{type}
...
and $k$ are integers. This last expression indicates three things to \kbd{gp}:
...
functions are automatically reduced to lowest terms under \kbd{gp}. All that was
