...
\tet{return}, or \kbd{C-d} (\kbd{EOF}), any of which will let \kbd{gp}
...
cleanup (in particular, user variables are restored to their former values).
...
will send you back to the prompt.
