...
internal parameters of GP, or \var{defaults}. See \secref{se:defaults} below
...
line as above, or interactively during a GP session or in a preferences file
...
\subsecidx{TeXstyle} (default \kbd{0}): the bits of this default allow GP
...
GP knows quite a lot of different operators, some of them unary (having only
...
If GNU \idx{Emacs} is installed on your machine, it is possible to use GP as
