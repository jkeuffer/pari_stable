...
\subsec{Error messages} (\tet{t_ERROR}): Objects of this type are created when an error
occurs and are immediately printed to the terminal and GP enters the "break loop".
You can create such objects using the \tet{error()} function.
