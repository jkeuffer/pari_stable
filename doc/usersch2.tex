...
internal type \typ{QFI}) since $2^2 - 4\times 3 = -8$ is negative. Although
...
\subsecidx{histfile} (disabled by default): name of a file where
...
default in your gprc saves your readline history between sessions.
...
\subsecidx{path} (default \kbd{".:\til:\til/gp"} on UNIX systems, \kbd{".;C:\bs;C:\bs GP"} on DOS, OS/2 and Windows, and \kbd{"."} otherwise):
