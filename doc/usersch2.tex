...
\kbd{gp [--default \var{key}=\var{val}] [\var{files}]}
...
startup. There can be any number of arguments of the form \kbd{--default
\var{key}=\var{val}}, setting some internal parameters of \kbd{gp}, or
\var{defaults}: each set the default \var{key} to the value \var{val}. See
