...
Note that the default \kbd{newgaloisformat} is another compatibility setting,
which is set independantly of \kbd{compatible}.
...
\subsecidx{newgaloisformat} (default \kbd{0}): if this is set, the
...
command line switches are given, they will override the values read from the
\kbd{gprc} file.
