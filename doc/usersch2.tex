...
If $f$ is a \typ{FFELT}, the following member function is defined:

\kbd{f.pol}: return the polynomial (with reduced integers coefficients)
...
If $a$ is a \typ{PADIC}, the following member function is defined:

\kbd{a.mod}: return the modulus $p^k$.
