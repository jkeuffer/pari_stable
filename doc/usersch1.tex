...
(actually called \typ{COMPLEX}). However, the components (i.e.~the real and
...
\subsec{Intmods, rational numbers (irreducible or not), $p$-adic numbers,
polmods, and rational functions}:\sidx{intmod}\sidx{rational
...
There is also a very large package which enables the number theorist to work
