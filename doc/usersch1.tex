...
(ask your favourite Web search engine for the site nearest to you). But, if
you want the very latest version (including development versions), you should
use the anonymous ftp address

\kbd{ftp://pari.math.u-bordeaux.fr/pub/pari}

\noindent
where you will find all the different ports and possibly some binaries. A lot
of version information, mailing list archives, and various tips can be found
on PARI's (fledgling) home page:
