...
\kbd{C\_INCLUDE\_PATH} is \emph{prepended} to the list of directories
searched for include files. Note that adding \kbd{-I} flags 
\kbd{CFLAGS} will \emph{not} be enough since \kbd{Configure} sometimes
relies on find the include files and parsing them, and it does not 
