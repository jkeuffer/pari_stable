...
with some extra capabilities (a single package for now!).
...
If desired, read \kbd{\$datadir/misc/gpalias} (unless you tampered with this via
Configure, \kbd{datadir} is \kbd{\$prefix/share/pari}) from the \kbd{gprc}
