...
we can provide a list of primes as an optional second argument: this returns
a basis of an order which is $p$-maximal at the given primes.
For example coming back to
...
known to \kbd{addprimes}, then \kbd{B = nfbasis(T, y)} returns a basis for
