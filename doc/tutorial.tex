...
the points. (And another proof that \kbd{q} is not torsion, assuming Mazur's
bound on the size of the rational torsion.) We could can also type
...
dependency.  Let's find them all. Type
\bprog
  vp = [v[1],v[2],v[3]]~;
...
dependency, otherwise not.  This is safer than using the \kbd{matker}
function. Thus, type
\bprog
