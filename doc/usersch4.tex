...
For instance, \kbd{pari\_err(e\_TYPE,"extgcd")} prints the message:
\bprog
    ***   incorrect type in extgcd.
@eprog\noindent See \secref{se:errors} for details.
...
if (maxprime() < goal) pari_err(e_MAXPRIME, goal); /*@Ccom not enough primes */
