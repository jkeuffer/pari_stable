...
describes all public low-level functions, and chapter 6 is specific to
...
\noindent The following further functions and macros are available:
...
\noindent A simple variant to \kbd{pari\_printf} is
