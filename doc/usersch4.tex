...
be overwritten: they should no longer be accessed \kbd{avma} has been
restored.
...
or a string respectively.  \tet{flush} is called to finalize (flush)
error messges in normal circumstances, and \tet{die} is a variant of
flush that (if non-\kbd{NULL}) is used if a fatal error has occurred.
