...
\tet{gen_2} and \tet{gen_m2}), the fraction $\dfrac{1}{2}$ (\tet{ghalf}), the
complex number $i$ (\tet{gi}). All of these are of type \kbd{GEN}.
...
\item \tet{forprime}, for which we refer you to Appendix B (the section about
PARI's private prime table)
