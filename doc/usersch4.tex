...
which do not belong on the stack): the integers 0, 1, -1 and 2 (respectively
called \teb{gzero}, \teb{gone}, \teb{gminusone} and \teb{gtwo}), the fraction
$\dfrac{1}{2}$ (\teb{ghalf}), the complex number $i$ (\teb{gi}). All of these
are of type \kbd{GEN}.
...
decreasing degree.
\bprog
  coefs_to_pol(3, gone, gtwo, gzero);
@eprog
...
instead to the current value of the \kbd{gp} variable (e.g \kbd{gone}).
