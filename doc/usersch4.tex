...
\fun{char*}{gpmalloc}{size_t size} calls \kbd{malloc} to allocate
...
\fun{char*}{gprealloc}{void* ptr, size_t size} as \kbd{gpmalloc} but calls
\kbd{realloc} instead of \kbd{malloc}.

\fun{char*}{gpfree}{void* ptr} calls \kbd{free} to liberate the memory space
