...
@eprog
%
\noindent To create space for the matrix elements themselves,
follow this with a double loop, filling each column vector.
...
modifier}~\kbd{Z} to specify that an argument is a \kbd{GEN}. For instance,
the following are valid conversions for a \kbd{GEN} argument
\bprog
    ...
    pari_printf("x[%d] = %Zs is not invertible!\n", i, gel(x,i));
@eprog\noindent
