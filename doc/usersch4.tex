...
\bprog
GEN gy = gp_read_str("'y"); /*@Ccom returns polx[$v$], for some $v$ */
long v = varn(gy);
@eprog\noindent
...
\fun{GEN}{gp_read_file}{FILE *file}
...
\kbd{gp\_read\_str} to it, and returns the resulting \kbd{GEN}. This way, you do
not have to worry about allocating buffers to hold the string. To
interactively input an expression, use \kbd{gp\_read\_file(stdin)}.
