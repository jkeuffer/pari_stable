...
there are three \tet{varargs} functions:
...
returns the \typ{VEC} whose $n$ coefficients (\kbd{GEN}) follow. If you
would rather have a \typ{COL}, use \kbd{settyp}.

\misctitle{Warning} Contrary to the policy of general PARI functions, the
latter two functions do \emph{not} copy of its arguments, nor do they produce
