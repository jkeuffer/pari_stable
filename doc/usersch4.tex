...
message. For instance, \kbd{pari_err(typeer,"extgcd")} prints the message:
...
\kbd{pari_err(warner, "Strategy 1 failed. Trying strategy 2")}

\noindent which is the exact equivalent of \kbd{pari_err(talker,...)} except that
