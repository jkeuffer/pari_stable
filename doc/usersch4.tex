...
which you probably do not need. Note that \kbd{gp}'s metacommands are not
recognized.
...
\fun{char*}{GENtostr}{GEN obj}, which returns a \kbd{malloc}'ed character
...
\kbd{nb} words corresponding to leaves. If you set $\kbd{nb} = -1$, all
words are printed.
