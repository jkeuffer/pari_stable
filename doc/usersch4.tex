...
differences for $p < maxp$) on the fly.
...
differences for $p < maxp$) and assign it to \kbd{diffptr}. You should refrain
from changing \kbd{diffptr} and call this function instead.
...
\subsubsec{High-level interface}
...
information in the preallocated \tet{forprime_t} struct.

The typical usage is thus:
\bprog
  forprime_t T;
  GEN p;
  pari_sp av = avma, av2;
