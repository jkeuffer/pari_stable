...
finite field), \kbd{fforder} (the multiplicative groupe of a finite field),
...
All such functions allow an optional argument specififying an integer
$N$, representing the order of the group. (The \emph{order} functions also
allow any non-zero multiple of the order, with a minor loss of efficiency.)
...
\item \typ{VEC}: this is the preferred format and provides both informations
in a two-component vector \kbd{[$N$, fa]}.
