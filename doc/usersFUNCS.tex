...
\kbd{realprecision}.  This precision (the number of decimal digits) can be
...
\item A \emph{relative matrix} is a matrix whose entries are elements of $K$, in
any form.
