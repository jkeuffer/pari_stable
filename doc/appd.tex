...
\fun{GEN}{pari_thread_init}{struct pari_thread *t}
Initialize the thread using the PARI thread data \kbd{pth} and return the
thread argument.

\fun{void}{pari_thread_close}{void}
Free memory used by this thread. Any \kbd{GEN} objects returned by this thread
