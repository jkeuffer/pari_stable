...
\li{Catalan's constant $C =.91596\cdots$}{Catalan}
\li{Euler's constant $\gamma =.57721\cdots$}{Euler}
...
\li{as above, give $[u,v,d]$, $xu + yv = d$}{polresultantext$(x,y,\{v\})$}
...
\li{discrete logarithm of $x$ in base $g$}{znlog$(x,g,\{o\})$}
...
\li{add points $P+Q$ / $P-Q$}{elladd$(ell,P,Q)${\rm, }ellsub}
\li{negate point}{ellneg$(ell,P)$}
\li{compute $n\cdot z$}{ellmul$(ell,z,n)$}
...
\li{is $L/K$ abelian?}{rnfisabelian$(\var{nf},g)$}
...
\li{relative HNF / SNF}{nfhnf$(\var{nf},x)${\rm, }nfsnf}
