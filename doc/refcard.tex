...
\def\versionnumber{2.23}% Version of this reference card
\def\PARIversion{2.4.2}% Version of PARI described on this reference card
\def\year{2007}
\def\month{August}
...
\li{$n$-th Tchebicheff polynomial}{polchebyshev$(n)$}
