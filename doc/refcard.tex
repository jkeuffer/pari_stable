...
% Copyright (c) 1997-2004 Karim Belabas.
...
\def\versionnumber{2.18}% Version of this reference card
\def\PARIversion{2.2.8}% Version of PARI described on this reference card
\def\year{2004}
\def\month{September}
...
\li{interpolating poly at $a$}{polinterpolate$(X,\{Y\},\{a\},\{$\&$e\})$}
...
\li{exports a group for GAP or MAGMA}{galoisexport$(G)$}
