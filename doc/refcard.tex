...
% Reference Card for PARI-GP version 2.0

% Copyright (c) 1997-1999 Karim Belabas. May be freely distributed.
%
...
\def\versionnumber{2.8}% Version of this reference card
\def\PARIversion{2.0.15}% Version of PARI described on this reference card
\def\year{1999}
\def\month{April}
...
\centerline{GP copyright by C.Batut, K. Belabas, D.Bernardi, H.Cohen, M.Olivier}
...
$X$ is the formal parameter used in the expression \seq\ (or \expr).\hfill
\subsec{Control Statements}
...
\li{start a new iteration of enclosing loop}{next$()$}
