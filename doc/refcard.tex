...
% Copyright (c) 1997-2000 Karim Belabas. May be freely distributed.
...
\def\versionnumber{2.9}% Version of this reference card
\def\PARIversion{2.0.19}% Version of PARI described on this reference card
\def\year{2000}
\def\month{April}
