...
\def\versionnumber{2.25}% Version of this reference card
\def\PARIversion{2.4.3}% Version of PARI described on this reference card
\def\year{2008}
\def\month{July}
...
\key{set output mode (raw=0, default=1)}{\\o $n$}
...
\li{reduce $x$ ($s =\sqrt{D}$, $l=\{\fl\}oor{s}$)}
  {qfbred$(x,\{\fl\},\{D\},\{l\},\{s\})$}
...
\key{number of real/complex places}{\var{nf}.r1, \var{nf}.r2, \var{nf.sign}}
...
\key{big ideal structure}{\var{bnr}.bid}
\key{modulus}{\var{bnr}.mod}
