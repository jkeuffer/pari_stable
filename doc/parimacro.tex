...
\ifeof\std
  ...
  \def\wwwsite{\kbd{http://pari.math.u-bordeaux.fr/}}
\else
  \input\@stdfile
\fi
...
\def\authors{
  ...
  \centerline{\tt ftp://pari.math.u-bordeaux.fr/pub/pari/}
  \vskip 1.truecm
}
...
\begintitle
\vskip 14cm
\noindent Copyright \copyright\ 2000--2003 The PARI Group
\medskip\par
...
\bigskip\par
\noindent PARI/GP is Copyright \copyright\ 2000--2003 The PARI Group
\medskip\par
