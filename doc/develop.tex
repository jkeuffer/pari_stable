...
\kbd{cmul(E,P,a,y)} must return the coefficient of degree $a$ of $P$ multiplied
by $y$.

The flag \kbd{use\_sqr} has the same meaning as for
\kbd{gen\_powers}. This implement an algorithm of Brent and Kung (1978).

\fun{GEN}{gen_bkeval_powers}{GEN P, long d, GEN V, void *E, const struct bb_field *ff,
