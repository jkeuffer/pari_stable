...
and a shallow copy of the malloced vector is made. \kbd{gcopy}, \kbd{gclone},
...
by \kbd{gp2c}. We document them here for completess.

\subsec{Output}

\fun{void}{print}{GEN g}

\fun{void}{print1}{GEN g}

\fun{void}{printf0}{GEN fmt, GEN args}

\fun{void}{printf1}{const char *fmt, ...}

\fun{void}{printtex}{GEN g}

\fun{void}{write0}{const char *s, GEN g}

\fun{void}{write1}{const char *s, GEN g}

\fun{void}{writetex}{const char *s, GEN g}
...
\fun{GEN}{gp_default}{const char *a, const char *b}

\fun{GEN}{setdefault}{const char *s, const char *v, long flag}

\fun{char*}{os_getenv}{const char *s}

\fun{long}{allocatemoremem}{size_t newsize}



\chapter{Regression tests, benches}

This chapter documents how to write an automated test module, say \kbd{fun}, so
that \kbd{make test-fun} executes the statements in the \kbd{fun} module
