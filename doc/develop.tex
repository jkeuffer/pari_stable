...
\fun{GEN}{gen_ZpX_Dixon}{GEN F, GEN V, GEN p, long N, void *E,
                            GEN lin(void *E, GEN F, GEN z, GEN q),
                            GEN invl(void *E, GEN z)}

Let $F$ be a \typ{VEC} of \kbd{ZpX} being the coefficients of some abstract
linear mapping $f$ over $\Z_p[X]$ seen as a free $\Z_p$-module, and let $V$ be
an element of $\Z_p[X]$.  Return $y\in\Z_p[X]$ such that $f(y)=V\pmod{p^N}$
assuming the following holds for $n\leq N$:
...
\fun{GEN}{gen_ZpX_Newton}{GEN x, GEN p, long n, void *E,
                          ...
                          GEN invd(void *E, GEN b, GEN v, long N)}
...
\item $w = \kbd{invd}(E,b,v,M)$ is an element in $\Z_p[X]$,
