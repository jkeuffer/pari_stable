...
\item \kbd{s[4]} points to extra data that link the compiled code to the source code. This is used for error reporting and debugging. The exact format is
in flux. Inline closures source code is stored in the parent function or
true closure.
