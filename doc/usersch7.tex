...
cannot be represented in this model; this is harmless, since they do not belong
to any elliptic curve $E$.
...
complexity, \kbd{ell5} (a $5$-tuple as above), \kbd{smallell} (small,
containing algebraic data defined over any domain), and \kbd{ell} (contains
additional analytic data for curves defined over $\R$ or $\Q_p$). The last
two types are produced by :
