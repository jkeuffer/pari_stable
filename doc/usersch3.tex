...
columns. The first contains the prime factors $p$, the second the
corresponding elements $a_p$ as in Proposition~8.3.1 in GTM~138, and
the third the output of isprime(p,2).
