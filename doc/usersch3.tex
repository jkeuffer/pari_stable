...
or power series $x$, with respect to the main variable of $x$. In particular
...
which are $K$-linearly independant. Most \var{rnf} routines return and handle
...
The following error handler stores in the file \kbd{crash} the names and
values of all user variables:\kbdsidx{writebin}
\bprog
? trap(, writebin("crash"))
@eprog
