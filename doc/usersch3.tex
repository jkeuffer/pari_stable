...
with a prime ideal factorization in the number field. The resulting ideal is
...
If not, $f$ can either be a vector (as above with $e$ containing only $1$s)
or a regular factorization, as produced with any \kbd{factor} command.
Examples:
\bprog
? factorback([2,2; 3,1])
%1 = 12
