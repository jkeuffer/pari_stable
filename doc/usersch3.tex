...
return the product of the $x[i]^{e[i]}$. In case separate \typ{VEC} $x$ and
$e$ are originally available, it is more convenient (and legible) to use
this trick than to build a legitimate factorization; compare
\bprog
factorback([x, e])
