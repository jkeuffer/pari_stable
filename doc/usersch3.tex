...
\syn{nfbasis0}{x,\fl,fa}. An extended version is
\funs{nfbasis}{x,\&d,\fl,fa}, where $d$ receives the discriminant of the
number field (\emph{not} of the polynomial $x$), and an omitted $fa$ is input
