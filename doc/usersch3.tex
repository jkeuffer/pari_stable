...
transcendental functions, an integer is \var{not} converted to a real
number before applying \kbd{abs}. If $x$ is a polynomial, returns $-x$ if
the leading coefficient is real and negative else returns $x$.
