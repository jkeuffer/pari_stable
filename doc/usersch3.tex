...
tricky we will not give any details, although the reader can try and figure
...
@eprog\noindent
One could then integrate $f_1$ between $a$ and $b$ with the call
\bprog
...
\synt{intnum}{void *E, GEN (*eval)(GEN,void*), GEN a,GEN b,GEN tab, 
long prec}, where an omitted \var{tab} is coded as \kbd{NULL}.
