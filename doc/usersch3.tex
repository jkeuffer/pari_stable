...
Set $H$ the maximal normal supersolvable
subgroup of $G$, we have the following properties:
...
Note that \kbd{G=galoisinit(pol);galoispermtopol(G,G[6])~} is equivalent to
\kbd{nfgaloisconj(pol)}, if degree of \var{pol} is greater or equal to $2$.
