...
\syn{poltchebi}{n,v}, where $n$ and $v$ are \kbd{long}
integers ($v$ is a variable number).

\subsecidx{poltchebi2}$(n,\{v=x\})$: creates the $n^{\text{th}}$
\idx{Chebyshev} polynomial~$U_n$ of the second kind in variable $v$.

\syn{poltchebi2}{n,v}, where $n$ and $v$ are \kbd{long}
integers ($v$ is a variable number).
