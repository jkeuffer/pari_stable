...
? factornf(x^2 + 1, y^2+1); \bs\bs\text{ these two are OK}
...
\bprog
? nf = nfinit(y^2 + 1);
? nffactor(nf, x^2 + y); \bs\bs\text{ OK}
? nffactor(nf, x^2 + Mod(y, y^2+1)); \bs\bs\text{ OK}
? nffactor(nf, x^2 + Mod(z, z^2+1)); \bs\bs\text{ illegal}
\eprog
...
? pol = z[1] \q\q\bs\bs\text{ \kbd{pol} defines the compositum}
\%2 = x^20 + 5*x^19 + 15*x^18 + 35*x^17 + 70*x^16 + 141*x^15 + 260*x^14 \bs
\q + 355*x^13 + 95*x^12 - 1460*x^11 - 3279*x^10 - 3660*x^9 - 2005*x^8 \bs
\q + 705*x^7 + 9210*x^6 + 13506*x^5 + 7145*x^4 - 2740*x^3 + 1040*x^2 \bs
\q - 320*x + 256
? a = z[2]; a^5 - 5 \q\q\bs\bs\text{ \kbd{a} is a fifth root of $5$.}
\%3 = 0
? z = polredabs(pol, 1); \q\q\bs\bs\text{ look for a simpler polynomial}
? pol = z[1]
\%5 = x^20 + 25*x^10 + 5
? a = subst(a.pol, x, z[2]) \q\q\bs\bs\text{ \kbd{a} in the new coordinates}
...
\%4 = [e, d, c]
? vecextract([1,2,3], "^2") \bs\bs~complement
\%5 = [1, 3]
...
\bprog%
? prod(i=1, 100, 1 - X^i);  \bs\bs\ this has degree $5050$~!!
\smallskip%
time = 3,335 ms.
\smallskip%
...
time = 43 ms.
\smallskip%
\%2 = 1 - X - X^2 + X^5 + X^7 - X^12 - X^15 + X^22 + X^26 - X^35 - X^40 + X^51
+ X^57 - X^70 - X^77 + X^92 + X^100 + O(X^101)%
\eprog
...
\q entree *ep = is\_entry("i");
\q /* sum for a <= i <= b */
\q return somme(ep, a, b, "i^2", gzero);
\cbr
\eprog
