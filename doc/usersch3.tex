...
convert an elliptic curve name (as found in the elldata database) from a string
to a triplet $[\var{conductor}, \var{isogeny class}, \var{index}]$. It will
also convert a triplet back to a curve name.
