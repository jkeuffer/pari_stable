...
The output is an 8-component vector \var{gal}.
 ...
 $\var{gal\/}[4]$ is the inverse of the Van der Monde matrix of the  $l$-adic roots of \var{pol}.
...
\quad$\bullet$ if not , set $H$ the maximal normal supersolvable soubgroup of $G$,
...
In this implementation the $o_i$ are prime power. It can be relaxed in the future.
