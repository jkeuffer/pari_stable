...
\subsecidx{perfectexponent}$(x,\{\&n\})$: return the maximal $k \geq 1$ such
that $x = n^k$ is a perfect power. If $n$ is given puts the exact $k$-th root
there. 

\syn{perfectexponent}{x, \&n}, the result is a \kbd{long}.
