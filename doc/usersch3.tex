...
function \funs{polcoeff}{x,n} gives the coefficient of degree $n$ of the
...
may be directly useful. Access to this information via
\var{member functions} is prefered since the specific data organization
specified below may change in the future. Currently, \kbd{nf} is a row
...
\subsubsecidx{trap}$(\{e\}, \{\var{sec}\}, \{\var{rec}\})$: tries to
