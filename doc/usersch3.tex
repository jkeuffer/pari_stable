...
appear between brackets as in \kbd{Z_issquare}$(x,\{\&e\})$.
...
\subsecidx{Z_issquare}$(x,\{\&n\})$: true (1) if $x$ is a square, false (0)
...
\bprog
    ? Z_issquare(3)          \\ as an integer
    %1 = 0
    ? Z_issquare(3.)         \\ as a real number
    %2 = 1
    ? Z_issquare(Mod(7, 8))  \\ in Z/8Z
    %3 = 0
    ? Z_issquare( 5 + O(13^4) )  \\ in Q_13
    %4 = 0
@eprog
