...
\subsecidx{numbpart}$(x)$: gives the number of partitions of $x$; the
number of nonnegative integer solutions to $a+2b+3c+\cdots=x$. $x$
must be of type integer and $1\le x<10^{15}$.
