...
$\bullet$ a vector or a quadratic form (in which case the resulting vector is
simply the initial object considered as a column vector),

$\bullet$ a matrix (the column of row vectors comprising the matrix is
returned),

$\bullet$ a character string (a column of individual characters is returned),

$\bullet$ a polynomial or a power series. In the case of a polynomial, the
...
$\bullet$ a vector or a quadratic form (in which case the resulting vector
is simply the initial object considered as a row vector),

$\bullet$ a matrix (the vector of columns comprising the matrix is return),

$\bullet$ a character string (a vector of individual
...
abscissa of integration, and then the function to be integrated is assumed to
