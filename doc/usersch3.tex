...
$\var{bnf}[4]$ contains the matrix $WB_C$ of Archimedean components of the
...
may be elements of $b$ or their inverse (possibly \idx{LLL}-reduced),
whichever has smallest norm.
