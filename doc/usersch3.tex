...
\item If $I = \{{\Bbba}_1,\dots, {\Bbba}_n}$ is an ideal list and $A
...
integers ($v$ is a variable number). Also available are \tet{polchebyshev1}
and polchebyshev2 for $T_n$ and $U_n$ respectively.
