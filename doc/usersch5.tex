...
\fun{long}{min}{long a, long b}

\fun{long}{max}{long a, long b} These two functions are implemented as macros
and evaluate twice each of their arguments.

\fun{long}{minss}{long x, long y} safe variant of \kbd{min}.

\fun{long}{maxss}{long x, long y} safe variant of \kbd{max}.
