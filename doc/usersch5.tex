...
positive representative of $x^{-1}$ modulo $2^\B$, assuming $x$ is odd.
...
\fun{GEN}{sqri}{GEN x} squares the \typ{INT}~$x$.

\fun{GEN}{sqrr}{GEN x} squares the \typ{REAL}~$x$.
...
convert each entry to \typ{POLMOD} with \typ{INTMOD} coefficients, and return
a \typ{COL}.
