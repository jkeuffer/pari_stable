...
them are suitable for \tet{gerepileupto}.

\fun{GEN}{row}{GEN A, long x1}

\fun{GEN}{row_i}{GEN A, long x0, long x1, long x2}

\fun{GEN}{rowextract_i}{GEN A, long x1, long x2}

\fun{GEN}{rowextract_ip}{GEN A, GEN p, long x1, long x2}

\fun{GEN}{rowextract_p}{GEN A, GEN p}

\fun{GEN}{gtrans_i}{GEN x}

\fun{GEN}{vconcat}{GEN A, GEN B}

\fun{GEN}{vecextract_i}{GEN A, long y1, long y2}

\fun{GEN}{vecextract_ip}{GEN A, GEN p, long y1, long y2}

\fun{GEN}{vecextract_p}{GEN A, GEN p}
