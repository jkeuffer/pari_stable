...
\kbd{nf}. Orders by increasing primes, breaking ties using
...
\fun{GEN}{Q_abs}{GEN x} absolute value of the \typ{INT} or \typ{FRAC}~\kbd{x}
...
\fun{GEN}{dotproduct}{GEN x,GEN y} returns the scala product of $x$ and $y$

\fun{GEN}{dotproduct_i}{GEN x,GEN y} as \kbd{dotproduct} assuming $x$ and $y$
have \typ{INT} entries.

\fun{GEN}{dotsquare}{GEN x} returns the scala product of $x$ with itself.

\fun{GEN}{dotsquare_i}{GEN x} as \kbd{dotsquare} assuming $x$
has \typ{INT} entries.
