...
\subsec{e\_DIM} arguments submitted to function $s$ have inconsistent
...
\subsec{e\_PRIME} Function $s$ expected a prime number, and did receive $p$,
...
\subsec{e\_SQRTN} Tried to compute an $n$-th root of $x$, which does not exist.
