...
\fun{GEN}{FF_Q_add}{GEN a, GEN y} returns $a + x$, where \kbd{a} is a
\typ{FFELT}, and \kbd{x} can be converted to the prime field of
\kbd{a} (via \tet{Rg_to_Fp}). Applies in particular for \kbd{x}
