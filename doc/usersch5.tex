...
whose address is passed as the \kbd{r} argument. All \kbd{GEN}s, whether
...
\fun{long}{smodsi}{long x, GEN y} computes the Euclidean
remainder of the long~\kbd{x} by the integer~\kbd{|y|}.

\fun{ulong}{umodiu}{GEN x, ulong y} computes the Euclidean
remainder of the integer~\kbd{|x|} by the unsigned long~\kbd{y}.

\fun{ulong}{umodui}{ulong x, GEN y} computes the Euclidean
