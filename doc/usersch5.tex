...
vector/matrix: the index is less than $1$ or greater than the vector length.
\bprog
  pari_err(e_COMPONENT, const char *op, GEN lim, GEN x)
  pari_err_COMPONENT(const char *op, GEN lim, GEN x)
@eprog\noindent prints the error message: \kbd{non-existent component: index
\var{op} \var{lim}}.
