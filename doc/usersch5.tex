...
behaviour is undefined at negative integers.
...
\fun{GEN}{FpXQYQ_mul}{GEN x, GEN y, GEN S, GEN T, GEN p}, \kbd{x}, \kbd{y} and
\kbd{T} being \kbd{FpXQX}s, returns $\kbd{x}\*\kbd{y}$ modulo \kbd{S}.

\fun{GEN}{FpXQYQ_sqr}{GEN x, GEN S, GEN T, GEN p}, \kbd{x} and
\kbd{T} being \kbd{FpXQX}s, returns $\kbd{x}^2$ modulo \kbd{S}.
...
\kbd{T} being \kbd{FqX}s, returns $\kbd{x}\*\kbd{y}$ modulo \kbd{S}.

\fun{GEN}{FqXQ_sqr}{GEN x, GEN S, GEN T, GEN p}, \kbd{x} and
\kbd{T} being \kbd{FqX}s, returns $\kbd{x}^2$ modulo \kbd{S}.

\fun{GEN}{FqXQ_pow}{GEN x, GEN n, GEN S, GEN T, GEN p}, \kbd{x} and
\kbd{T} being \kbd{FqX}s, returns $\kbd{x}^\kbd{n}$ modulo \kbd{S}.
...
\fun{GEN}{FpX_rem_Montgomery}{GEN x, GEN mg, GEN T, ulong p}, returns \kbd{x}
