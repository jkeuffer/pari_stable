...
\fun{GEN}{FpXQ_log}{GEN a, GEN g, GEN ord, GEN T, GEN p} Let $g$ such that
$g^ord=1$ in the field $F_p[X]/(T)$. Return $e$ such that $a^e=g$. If $e$ does
not exists, the result is currently undefined.
...
\fun{GEN}{Flxq_log}{GEN a, GEN g, GEN ord, GEN T, ulong p} Let $g$ such that
$g^ord=1$ in the field $F_p[X]/(T)$. Return $e$ such that $a^e=g$. If $e$ does
not exists, the result is currently undefined.
