...
\doc{cb_pari_err_recover}{extern void (*cb_pari_handle_exception)(long)}
initialized to \kbd{pari_exit()}. This call-back must not return.
...
checks against \kbd{pari-1.39.15}).
...
There is a corresponding library interface for this functionality, letting
...
result otherwise, or \kbd{NULL} if a flow change occurred.
