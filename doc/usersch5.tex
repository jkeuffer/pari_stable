...
\noindent $\tet{BITS_IN_LONG}$: number of bits in a \kbd{long} (32 or 64).

\noindent \tet{BITS_IN_HALFULONG}: \kbd{BITS\_IN\_LONG} divided by $2$.

\noindent \tet{LONG_MAX}: the largest positive \kbd{long}.

\noindent \tet{ULONG_MAX}: the largest \kbd{ulong}.
