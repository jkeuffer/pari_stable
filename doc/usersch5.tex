...
modulo \kbd{n} (possibly not prime), where \kbd{x}, \kbd{n} are \typ{INT}s.
Return \kbd{NULL} if no such square root exist.
...
\fun{GEN}{Qp_sqrtn}{GEN x, GEN n, GEN *zetan} shortcut for \kbd{glog(x, n, zetan, /*ignored*/prec)}
