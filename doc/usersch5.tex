...
error-prone, and clumsy (need to declare an extre \kbd{GEN *g}).
...
\fun{void}{F2v_flip}{GEN x, long i} adds $1$ to the coefficient $i$ of $x$.

\fun{void}{F2v_set}{GEN x, long i} sets the coefficient $i$ of $x$ to $1$.
...
allowable for $y$ to be shorter than $x$.
