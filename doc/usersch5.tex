...
\noindent \tet{PARI_STATUS} contains the release's status (\kbd{release},
\kbd{development}, \kbd{alpha}, \kbd{beta}, \dots).

\noindent \tet{PARI_RCSVERSION} is a version  string related to the
...
\typ{VEC} with 3 \typ{INT} and 2 \typ{STR} components.
