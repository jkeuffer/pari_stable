...
\fun{GEN}{FpXQ_gener}{GEN T, GEN p) returns a primitive root modulo
...
\fun{GEN}{Flx_rand}{long d, long v, ulong p} returns a random \kbd{Flx}
in variable \kbd{v}, of degree less than~\kbd{d}.
...
\fun{GEN}{Flxq_gener}{GEN T, ulong p) returns a primitive root modulo
