...
a component of the input (obviously not suitable for \kbd{gerepileupto}).
This is used for member functions, to avoid costly copies.\cr
...
The \kbd{s*} code is technical. It reads all remaining arguments in
...
\misctitle{Hardcoded limit.} C functions using more than 8 arguments are not
