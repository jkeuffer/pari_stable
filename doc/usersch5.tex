...
The last two functions are not well defined in general and only provided for
convenience in specific cases:
...
Besises \tet{ZC_hnfrem} and \tet{ZM_hnfrem} which were specific to integral
input, we also have:
