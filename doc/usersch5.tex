...
are lifted elements of $R[X]/(T)$ for some base ring $R$ (number field
elements in most applications). Return a vector where all non-rational
entries are converted to \typ{POLMOD}. Used to normalize the output of
\kbd{nfroots}.
