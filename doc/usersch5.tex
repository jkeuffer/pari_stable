...
$-1$, and the number of the other variables is decreased by one unit. The
argument \kbd{code} must be the closure that references this lexical variable
(The closure contains the debugging data for the variable).
