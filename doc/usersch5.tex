...
one primary type \kbd{t1}, descrіbing the form of the quotient,
...
the subresultant algorithm (generic case), a modular algorithm (іnputs in
...
degree $1$ and the reѕidu field is $\F_p$.
