...
\fun{void}{pari_init}{size_t parisize, ulong maxprime} initialize the
...
\fun{void}{pari_init_opts}{size_t parisize, ulong maxprime, ulong
init_opts, entree **newfun, entree **oldfun} as \kbd{pari\_init}, with
...
\dkb{gp} uses \kbd{pari\_addfunctions} to bundle a series of new routines
