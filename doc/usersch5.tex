...
prime, to be given by the function arguments; an \kbd{Fl} is an \kbd{ulong}
...
small group of the same domain, returns the left coset $gG$ as a vector of
permutations.

\fun{GEN}{group_rightcoset}{GEN G, GEN g} where $G$ is a small group and $g$ a
small group of the same domain, returns the right coset $Gg$  as a vector of
permutations.

\fun{long}{group_perm_normalize}{GEN G, GEN g} where $G$ is a small group and
$g$ a small group of the same domain, return $1$ if $gGg^-1=G$, else $0$.
