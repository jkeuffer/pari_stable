...
\fun{GEN}{vecsmall_uniq_sorted}{GEN v} same as \kbd{vecsmall_uniq}, but assumes
 \kbd{v} sorted.
...
(\kbd{vecsmall_duplicate([1,1])} returns $2$).

\fun{long}{vecsmall_duplicate_sorted}{GEN v} same as
\kbd{vecsmall_duplicate}, but assume \kbd{v} sorted.
