...
\fun{bytepr}{initprimes}{ulong maxprime} computes a ``prime table'' on the fly.
In fact a table of all prime differences for $p < \kbd{maxprime}$.
...
\fun{ulong}{init_primepointer}{ulong a, byteptr *pd}
