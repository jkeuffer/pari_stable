...
\fun{long}{pari_var_next}{}: returns \kbd{nvar}.

\fun{long}{pari_var_max_avail}{} returns \kbd{max\_avail}.
...
current value of the variable numberd $v$. Return \kbd{NULL} for a temporary
variable.
...
if a variable is to de deleted, it should be a temp.
