...
\fun{void}{diviuexact}{GEN x, ulong y} returns the Euclidean quotient $\kbd{x}
...
is a fraction or rational function, this is used internally to handle
types \typ{FRAC} and \typ{RFRAC}.
