...
\fun{GEN}{FpXY_Fq_evaly}{GEN Q, GEN y, GEN p, long vy} $Q$ an \kbd{FpXY} and
$y$ being an \kbd{Fq}, returns the \kbd{FqX} $Q(X,y)$, where $X$ is the second
variable of $Q$.
...
\fun{GEN}{Flxq_autpow}{GEN a, long n, GEN T, ulong p} computes $\sigma^n(X)$
...
\fun{long}{FlxqX_Frobenius}{GEN f, GEN T, GEN p}, as \kbd{FpXQX\_Frobenius}

\fun{long}{FlxqX_nbroots}{GEN f, GEN T, GEN p}, as \kbd{FpX\_nbroots}.
...
\fun{GEN}{FlxqXQV_autpow}{GEN a, long n, long m, GEN S, GEN T, ulong p}
$\sigma$ being the automorphism defined by $\sigma(x)=a[1]\mod{T}$,
$\sigma(X)=a[2]\mod{S,T}$, returns $[\sigma^n(x),\sigma^n(X)]$.

\fun{GEN}{FlxqXQV_autsum}{GEN a, long n, GEN S, GEN T, ulong p}
$\sigma$ being the automorphism defined by $\sigma(x)=a[1]\mod{T}$,
$\sigma(X)=a[2]\mod{S,T}$, returns the vector
$[\sigma^n(x),\sigma^n(X),b\sigma(b)\ldots\sigma^{n-1}(b)]$
where $b=a[3]$.
