...
up to the maximum of \kbd{maxprime} and $2^{16}$.
...
\fun{void}{pari_add_function}{entree *ep} after \kbd{pari\_init} is
called, this function adds a single routine to the table of symbols in the
interpreter.
...
which are arrays of \kbd{entree}. There are currently six modules in GP:
general functions, gp-specific functions, gp-specific highlevel functions,
member functions, and two modules of obsolete functions. See e.g.
\kbd{src/language/init.h} for the modules of general functions.
