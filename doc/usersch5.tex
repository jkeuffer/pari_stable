...
\fun{GEN}{Fp_ellgroup}{GEN a4, GEN a6, GEN N, GEN p, GEN *pt_m}
Return the group structure $D$ of the curve $E:y^2=x^3+a_4\*x+a_6$ over
$F_p$, which is assumed to be of order $N$ and set $*pt_m=m$.

\fun{GEN}{Fp_ellgens}{GEN a4, GEN a6, GEN ch, GEN D, GEN m, GEN p}
Returns generators of the curve $E:y^2=x^3+a_4\*x+a_6$ over
$F_p$ with the base change \kbd{ch} (see \kbd{FpE\_changepoint}),
where $D$ and $m$ are as returned by \kbd{Fp\_ellgroup}.
...
Returns generators of the curve $E:y^2=x^3+a_4\*x+a_6$ over
$F_p$ with the base change \kbd{ch} (see \kbd{FpXQE\_changepoint}),
where $D$ and $m$ are as returned by \kbd{FpXQ\_ellgroup}.
