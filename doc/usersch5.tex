...
coefficients are $0$ using \kbd{gcmp0}. Set \kbd{*pz}, set it to
...
\fun{long}{RgX_valrem_inexact}{GEN P, GEN *z} as \kbd{RgX\_valrem}
...
as set by \kbd{primitive\_part} or \kbd{Q\_primitive\_part}: either a \kbd{GEN}
or \kbd{NULL} representing the trivial content $1$. Returns their product
(either a \kbd{GEN} or \kbd{NULL}).
