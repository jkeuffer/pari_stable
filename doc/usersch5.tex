...
\fun{GEN}{strtoclosure}{char *str, GEN data} returns a closure corresponding to the
built-in or install'ed function named \kbd{str} with the last parameters set to
the components of the vector \kbd{data}, see \tet{snm_closure}. This function
has an higher overhead since it copies \kbd{data} and does more input validation.
